...
const int sinogramHeight = 39; // total parallel x-ray projections
...
const int bpkernel_blocks = 3;
const int bpkernel_threads = 507;
...
int main(int argc, char ** argv) {
	...
	********************/
	...
	k_backprojection << < bpkernel_blocks, bpkernel_threads >> >(d_backProjection);
